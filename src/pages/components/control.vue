...
const sendVerificationCode = async () => {
  ...
  const command = `mail Admin 1 365 _TITLE verify _CONTENT Your verify code is:${generatedCode}.The verification code is the only proof of identity for the user, do not send it to others.`;
